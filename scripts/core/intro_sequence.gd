...
@onready var char_left_name: Label = $CharacterLayer/CharLeft/VBox/Name
@onready var char_left_text: Label = $CharacterLayer/CharLeft/VBox/Text
@onready var char_right_name: Label = $CharacterLayer/CharRight/VBox/Name
@onready var char_right_text: Label = $CharacterLayer/CharRight/VBox/Text
